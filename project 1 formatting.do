...
quietly infix                  ///
  ...
  int     educd       69-71    ///
  byte    gradeatt    72-72    ///
  byte    gradeattd   73-74    ///
  byte    schltype    75-75    ///
  byte    degfield    76-77    ///
  int     degfieldd   78-81    ///
  byte    degfield2   82-83    ///
  int     degfield2d  84-87    ///
  byte    empstat     88-88    ///
  byte    empstatd    89-90    ///
  byte    labforce    91-91    ///
  int     occ         92-95    ///
  int     ind         96-99    ///
  byte    classwkr    100-100  ///
  byte    classwkrd   101-102  ///
  byte    wkswork2    103-103  ///
  byte    uhrswork    104-105  ///
  long    inctot      106-112  ///
  long    ftotinc     113-119  ///
  long    incwage     120-125  ///
  using `"usa_00001.dat"'
...
describe, short
keep if occ==10 | occ==50
describe, short
save econ5813_acs_d1.dta, replace
